...
import static com.jian.github.event.EventType.TYPE_LOGIN;
import static com.jian.github.event.EventType.TYPE_LOGOUT;

public class MainActivity extends BaseActivity<MainContract.IMainView, MainContract.IMainPresenter>
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        UiUtils.setCenterTitle(toolbar, R.string.main_title);
